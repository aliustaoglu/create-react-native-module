...
```javascript
{
  ...
  fs: Object, /* Mockable `fs` object that should provide a few methods according to the `fs-extra` package API - unstable and subject to change (Default: `require('graceful-fs')`) */
