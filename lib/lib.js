...
// default fs object
const fsDefault = require('graceful-fs');
...
const generateWithOptions = ({
  ...
  fs = fsDefault, // (this can be mocked out for testing purposes)
  ...
  const generateExampleWithName =
    (exampleName) => {
      ...
      return Promise.resolve()
        .then(() => {
          // We use synchronous execSync call here which is able to output
